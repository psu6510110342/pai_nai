...
class FinishBrown extends StatefulWidget {
  static const String idScreen = 'FinishBrown';
  final int number;
  final int count;
  final String driveruid;
  FinishBrown({Key key, this.count, this.number, this.driveruid})
      : super(key: key);
  GoogleMapController newGoogleMapController;
  @override
  _FinishBrownState createState() => _FinishBrownState();
}

class _FinishBrownState extends State<FinishBrown>
